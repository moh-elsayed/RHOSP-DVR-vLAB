...
update_hosts()
{
  echo "172.17.17.251   rhn.vlab.local rhn" >> /etc/hosts
}
...
baseurl=http://rhn.vlab.local/repo/repos/rhel-7-server-openstack-10-rpms
enabled=1
gpgcheck=0

[MoeLocal-server-extras]
name=vlab Repo-extras
baseurl=http://rhn.vlab.local/repo/repos/rhel-7-server-extras-rpms
enabled=1
gpgcheck=0

[MoeLocal--server-rh-common]
name=vlab Repo-common
baseurl=http://rhn.vlab.local/repo/repos/rhel-7-server-rh-common-rpms
enabled=1
gpgcheck=0

[MoeLocal-server]
name=vlab Repo-server
baseurl=http://rhn.vlab.local/repo/repos/rhel-7-server-rpms
enabled=1
gpgcheck=0

[MoeLocal-server-satellite-tools]
name=vlab Repo-sattool
baseurl=http://rhn.vlab.local/repo/repos/rhel-7-server-satellite-tools-6.2-rpms
enabled=1
gpgcheck=0

[MoeLocal-ha-for-rhel-7-server]
name=vlab Repo-HA
baseurl=http://rhn.vlab.local/repo/repos/rhel-ha-for-rhel-7-server-rpms
enabled=1
gpgcheck=0

[MoeLocal-openstack-10-devtools]
name=vlab devtools
baseurl=http://rhn.vlab.local/repo/repos/rhel-7-server-openstack-10-devtools-rpms
enabled=1
gpgcheck=0

[MoeLocal-ceph-mon]
name=vlab Repo-Ceph-Mon
baseurl=http://rhn.vlab.local/repo/repos/rhel-7-server-rhceph-2-mon-rpms
enabled=1
gpgcheck=0

[MoeLocal-ceph-tools]
name=vlab Repo-CEPH-Tools
baseurl=http://rhn.vlab.local/repo/repos/rhel-7-server-rhceph-2-tools-rpms
enabled=1
gpgcheck=0

ScaleIO_2.0.1.3_RHEL_OEL7_Download
[MoeLocal-ScaleIO]
name=vlab ScaleIO
baseurl=http://rhn.vlab.local/repo/repos/ScaleIO_2.0.1.3_RHEL_OEL7_Download
enabled=1
gpgcheck=0
